...
{  
    ...
    {   
        ...
        if args[5]=="prod" // in prod mode
        {
            ...
            reactor::reactor_init(sorted.clone(), _index, args.clone(), "accum".to_string(), "prod_init".to_string()).await;
               
        }
        else 
        {                
           
            reactor::reactor_init(sorted.clone(), _index, args.clone(), "accum".to_string(), "dev_init".to_string()).await;
